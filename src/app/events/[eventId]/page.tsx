      ...
      <div className="mb-6">
        ...
        {event?.type === "team" ? (
          ...
          <div className="flex items-start justify-between gap-4 mt-7 flex-wrap">
            ...
            {/* Right: Share + Present */}
            <div className="shrink-0 self-start flex items-center gap-3 pt-1">
              <ShareButton />
              <a
  ...
  return (
    <div>
      <p className="text-sm font-medium text-gray-600">
        {etDateStr} · {etTimeStr} ET{statsStr}
      </p>
      {localTime && !viewerIsET && (
        <p className="text-sm text-gray-400 mt-1">{localTime} local time</p>
      )}
    </div>
  );
}
