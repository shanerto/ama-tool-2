...
export default function PresenterEventPage() {
  ...
  const T = {
    ...
    sortActive:     "bg-gray-900 text-white shadow",
          ...
          >
            ...
            <div className={`transition-all duration-200 ${T.questionCard}`}>
              ...
              <button
                ...
                className="mt-8 px-5 py-2 rounded-lg bg-gray-900 text-white text-sm font-medium hover:bg-gray-700 transition-colors"
